...
INSERT INTO [dbo].[Restaurants]
           ...
           ,[owner_id])
     VALUES
           (N'Mộc Long Tân Xã',N'Đi đâu cũng được, miễn là có món ngon nhà #Mộc_Long bên cạnh là được phải không cả nhà ơiii? Menu hấp dẫn với nhiều món thức uống thơm ngon ngọt ngào tại Mộc Long đang đợi các bạn thưởng thức, cứ đang thèm nhất món gì thì nhanh chóng chọn món và order ngay nhé! Hãy để món ngon nhà Mộc long up mood cho bạn mỗi ngày nha!','MocLong.jpg',N'Cổng Trường Hai Bà Trưng, Tân Xã, Thạch Thất, Hanoi, Vietnam','0988 948 583','2'),
		   (N'Crush - Tea&Coffee',N'CRUSH TEA & COFFEE Chuyên phục vụ Trà sữa Đài Loan, Đồ ăn Hàn Quốc, Bún đậu mẹt, Nem lụi (nem nướng), bánh mì chảo - Bít tết - thiên đường ăn vặt, Trà hoa quả....','Crush.jpg',N'2H92+RJ Tân Xã, Thạch Thất Hanoi, Vietnam 100000','	097 195 81 85','4'),
		   (N'Bánh mì phố',N'Bán bánh, xôi các loại. Kèm đồ uống siêu ngon','BanhMiPho.jpg',N'Bánh mì Phố thôn 3, cạnh trọ tuấn cường 2','0385 85 2696 ','5'),
		   (N'Mixue Tân Xã',N'MIXUE là thương hiệu trà sữa có vốn đầu tư Hong Kong','MixueTanXa.jpg',N'Đầu đường 49 - Tân Xã - Thạch Thất - Hà Nội, Hanoi, Vietnam','	0931 311 296','6'),
		   (N'Bamimo',N'Bán bánh mì mỏ nhưng ăn như các tiệm khác nhưng đắt hơn','Bamimo.jpg',N'Bánh mì Bamimo đối diện cây xăng 39','0975 486 919','7'),
		   (N'Cơm Rang Nguyễn Việt',N'Cơm bình dân giá sinh viên…RMIT','ComRangNguyenViet.jpg',N'Đối diên cây xăng 39, Thạch Hoà','035 6721 667','8'),
		   (N'Bún Đậu 1966',N'BÚN ĐẬU 1966 ngon đúng hương vị quê','	BunDau1966.jpg',N'QUÁN BÚN ĐẬU 1966, Tân Xã, Thạch Thất','097 959 8680','9'),
		   (N'Bún Đậu Cô Chang',N'Đời cha ăn mặn. Đời con ăn bún đậu mắm tôm','BunDauCoChang.jpg',N'Đối diện hồ câu Duy Minh, thôn 3, Thạch Hòa','0866 823 822','10'),
		   (N'Ngon Quán',N'Cơm ngon cơm ngon các em ơi!!!! Mừng khai trương  => đến mùng 3/03 mua 1 tặng 1 đồ uống các em nhé','"NgonQuan.jpg',N'SN 334 Đường 21, Thạch Hoà, Thạch Thất, Hà Nội 13113','033 765 3888','11'),
		   (N'Nem Nướng Hùng Anh',N'Cmt cho quán học cách đeo găng tay trước khi nặn thịt mà quán inb đòi nổ địa chỉ','NemNuongHungAnh.jpg',N'Đối diện cây xăng 39','034 243 6528','12');
